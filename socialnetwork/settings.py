...
# Email Settings
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' if DEBUG else 'django_smtp_ssl.SSLEmailBackend'
...
# Disable email confirmation temporarily to avoid 500 errors on signup
